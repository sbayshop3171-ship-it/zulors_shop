...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{ "Zulors Shop Software Installation" }}</h2>
        <h6 class="fw-normal">
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Zulors Shop Software Installation"
    ...
    <div class="card mt-4 position-relative">
        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">
                ...
                <a href="https://docs.zulors.com/docs-six-valley/admin-panel/install-on-server" target="_blank">
