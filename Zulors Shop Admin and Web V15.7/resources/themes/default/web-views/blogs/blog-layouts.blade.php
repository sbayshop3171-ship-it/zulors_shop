...
<script>
    ...
    $(document).on('click','#cookie-accept',function() {
        document.cookie = 'zulors_shop_cookie_consent=accepted; max-age=' + 60 * 60 * 24 * 30;
        $('#cookie-section').hide();
    });
    $(document).on('click','#cookie-reject',function() {
        document.cookie = 'zulors_shop_cookie_consent=reject; max-age=' + 60 * 60 * 24;
        $('#cookie-section').hide();
    });

    $(document).ready(function() {
        if (document.cookie.indexOf("zulors_shop_cookie_consent=accepted") !== -1) {
            $('#cookie-section').hide();
        }else if (document.cookie.indexOf("zulors_shop_cookie_consent=reject") !== -1) {
            $('#cookie-section').hide();
        } else{
