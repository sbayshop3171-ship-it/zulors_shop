...
@section('content')
    ...
    @include("taxmodule::zulors_shop.tax.partials.vat-tax-create")

    @foreach ($vatTaxes as $key => $vatTax)
        @include("taxmodule::zulors_shop.tax.partials.vat-tax-update", ['vatTax' => $vatTax])
    @endforeach

    @include("taxmodule::zulors_shop.offcanvas._vat-tax-create")
@endsection
