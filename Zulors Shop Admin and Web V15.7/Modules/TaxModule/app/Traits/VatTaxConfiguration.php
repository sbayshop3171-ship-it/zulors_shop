...
trait VatTaxConfiguration
{
    ...
    public static function getProjectWiseViewPath($name)
    {
        $allProjects = [
            ...
            'zulors_shop' => [
                'tax_list' => 'taxmodule::zulors_shop.tax.tax_list',
                'tax_list_export' => 'taxmodule::zulors_shop.file-exports.tax_list_export',
                'admin_tax_report' => 'taxmodule::zulors_shop.file-exports.admin_tax_report',
                'system_tax_setup' => 'taxmodule::zulors_shop.tax.system_tax_setup',
            ],
        ];
