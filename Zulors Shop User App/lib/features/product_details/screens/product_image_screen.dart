              ...
              pageIndex != 0 ? Positioned(left: 5, top: 0, bottom: 0,
                child: Container(alignment: Alignment.center,
                  ...
                  child: InkWell(
                    ...
                    child: Icon(Icons.chevron_left_outlined, size: 40, color: Theme.of(context).cardColor),
                  ),
                ),
              ...
              pageIndex != widget.imageList!.length-1 ? Positioned(
                ...
                child: Container(alignment: Alignment.center,
                  ...
                  child: InkWell(
                    ...
                    child: Icon(Icons.chevron_right_outlined, size: 40, color: Theme.of(context).cardColor))),
              ) : const SizedBox.shrink(),
            ],
          ),
        ),
