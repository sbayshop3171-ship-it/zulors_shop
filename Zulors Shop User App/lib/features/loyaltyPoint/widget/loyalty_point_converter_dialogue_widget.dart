...
import 'package:zulors_shop/features/loyaltyPoint/widget/how_to_use_dialog_widget.dart';
                      ...
                      child: CustomButton(leftIcon: Images.dollarIcon,
                        ...
                        onTap: (){
                          ...
                          if(point < min!){
                            ...
                            showCustomSnackBarWidget(getTranslated('minimum_point_is', context), context, snackBarType: SnackBarType.warning);
                          }
                          else if(point.toDouble() > widget.myPoint!){
                            Navigator.pop(context);
                            showCustomSnackBarWidget(getTranslated('insufficient_point', context), context, snackBarType: SnackBarType.warning);
                          } else{
