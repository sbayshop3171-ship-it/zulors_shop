...
import 'package:zulors_shop/features/review/widgets/review_dialog_widget.dart';
                            ...
                            child: InkWell(
                              onTap: () async {
                                ...
                                if(orderProvider.orderDetails?[widget.index].isExpanded ?? false){
                                  await Provider.of<ReviewController>(Get.context!, listen: false).getOrderWiseReview(
                            ...
                            return widget.orderDetailsModel.deliveryStatus == 'delivered' && widget.orderType != "POS" ? InkWell(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  color: Theme.of(context).colorScheme.secondary.withValues(alpha: 0.70),
                                ),
