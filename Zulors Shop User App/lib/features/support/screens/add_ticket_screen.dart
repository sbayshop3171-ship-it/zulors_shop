...
import 'package:zulors_shop/features/support/widgets/priority_bottom_sheet_widget.dart';
          ...
          builder: (context, supportTicketProvider, _) => Padding(
            ...
            child: CustomButton(buttonText: getTranslated('submit', context), onTap: () {
              if (_subjectController.text.isEmpty) {
                showCustomSnackBarWidget(getTranslated('subject_is_required', context), context, snackBarType: SnackBarType.warning);
              } else if (_descriptionController.text.isEmpty) {
                showCustomSnackBarWidget(getTranslated('description_is_required', context), context, snackBarType: SnackBarType.warning);
              }else if (supportTicketProvider.selectedPriorityIndex == -1) {
                showCustomSnackBarWidget(getTranslated('priority_is_required', context), context, snackBarType: SnackBarType.warning);
              } else {
