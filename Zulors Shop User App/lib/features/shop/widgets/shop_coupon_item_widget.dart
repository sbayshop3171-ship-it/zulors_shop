...
import 'package:zulors_shop/features/coupon/domain/models/coupon_item_model.dart';
                      ...
                      child: Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeSmall),
                        child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              '${getTranslated('available_till', context)} ${DateConverter.estimatedDate(DateTime.parse(widget.coupons.expireDatePlanText!))}',
