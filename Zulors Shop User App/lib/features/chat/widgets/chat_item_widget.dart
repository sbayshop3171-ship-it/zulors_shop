        ...
        return InkWell(
          onTap: (){
            ...
            if((name!.trim().isEmpty || name == 'Shop not found' || name!.trim()=='') && widget.chat?.adminId == null) {
              showCustomSnackBarWidget(getTranslated('user_account_was_deleted', context), Get.context!, snackBarType: SnackBarType.error);
            }else{
              widget.callBack();
              RouterHelper.getChatScreenRoute(
               ...
               userType: widget.chatProvider.userTypeIndex,
              );
            }
          },
            ...
            child: Padding(
              ...
              child: Row(children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                        ...
                        child: CustomImageWidget(
                            image:(widget.chat?.adminId == 0) ? "${splashController.configModel?.inHouseShop?.imageFullUrl?.path}" :'$image',
                ...
                Expanded(child: Column(children: [
                  ...
                  Row(children: [
                    (widget.chat?.adminId == 0) ?
                    Expanded(child: Text("${splashController.configModel?.inHouseShop?.name}",
                      maxLines: 1,
