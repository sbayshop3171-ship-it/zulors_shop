...
import 'package:zulors_shop/features/refund/widgets/refund_image_selection_widget.dart';
            ...
            builder: (context, refundController, _) {
              return Column(children: [
                ...
                Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall), child: CustomButton(
                  ...
                  if(reason.isEmpty) {
                    showCustomSnackBarWidget(getTranslated('reason_required', context)??'',  context,  snackBarType: SnackBarType.warning);
                  }else {
