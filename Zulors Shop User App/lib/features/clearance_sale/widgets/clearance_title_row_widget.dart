      ...
      child: Stack(children: [
        ...
        Positioned(child: Align(alignment: isHomeScreen ? Alignment.bottomCenter : Alignment.center, child: Padding(
          ...
          child: Row(
            ...
            Padding(
              padding: isLtr ? isHomeScreen ? const EdgeInsets.all(0) : const EdgeInsets.only(left: Dimensions.paddingSizeSmall) : const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
              child: Text(title!,
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
            ...
            onTap != null ? Padding(padding: const EdgeInsets.symmetric(horizontal: 0),
