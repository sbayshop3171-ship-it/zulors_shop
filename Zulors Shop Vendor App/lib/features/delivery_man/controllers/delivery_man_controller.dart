...
import 'package:zulors_shop_vendor/data/model/response/response_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/collected_cash_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/delivery_man_body.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/delivery_man_earning_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/delivery_man_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/delivery_man_order_history_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/delivery_man_review_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/delivery_man_withdraw_detail_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/delivery_man_withdraw_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/order_history_log_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/delivery_man_detail_model.dart' as d;
import 'package:zulors_shop_vendor/data/model/response/base/api_response.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/services/delivery_service_interface.dart';
import 'package:zulors_shop_vendor/features/order/domain/models/order_model.dart';
import 'package:zulors_shop_vendor/features/delivery_man/domain/model/top_delivery_man.dart';
...
import 'package:zulors_shop_vendor/helper/api_checker.dart';
import 'package:zulors_shop_vendor/helper/image_size_checker.dart';
    ...
    if(isRemove) {
      ...
      if (isProfile) {
        ...
        if(profileImage != null) {
          double fileSizeInMB = await ImageSize.getImageSizeFromXFile(profileImage);
        ...
        if (_identityImage != null) {
          double fileSizeInMB = await ImageSize.getImageSizeFromXFile(_identityImage!);
